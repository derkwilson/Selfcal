...
tag_save = 'result'  ; base name for output files
...
if (sip+bcd eq 0) then begin
 ;photometry for channels 1 & 2 raw data has to be negated.
  ...
  if (nh ge 1) then skies[h] = skies[h]+256.^2
endif
...
cr_flag = bytarr(256,256,nframes)+1B
